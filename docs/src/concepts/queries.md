...
The model's `all` method retrieves all records from the model's
...
Both directions work seamlessly — Fabrique generates the appropriate `Joinable`
implementations when you define a `belongs_to` relationship.
