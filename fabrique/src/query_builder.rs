...
//! ### Where Clauses
//!
//! You may use the query builder's where method to add [where][QueryBuilder::where] clauses to the
//! query. The most basic call to the where method requires three arguments. The
//! first argument is the name of the column. The second argument is an
//! operator, which can be any of the database's supported operators. The third
//! argument is the value to compare against the column's value.
//!
